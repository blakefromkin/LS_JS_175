/*
This final version further simplifies our createServer() callback function by implementing router middleware and serve-static middleware.
...
// This section defines our router function object and predefines our routes
let router = ROUTER();
router.use(SERVESTATIC('public'));

// The following routes replace our "request handler functions" from the previous version
...
router.post('/loan-offer', function (req, res) { // note: router.post not router.get
...
// The * (wildcard) character lets us use this as a "catch-all" route
router.get('*', function(req, res){
  res.statusCode = 404;
  res.end();
});
