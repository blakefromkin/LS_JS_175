/*
This version uses a form page to demonstrate the use of abstract paths.
*/
...
function getPathname(path) {
  const myURL = new URL(path, `http://localhost:${PORT}`);
  return myURL.pathname; // NOTE THAT THIS VARIABLE RETURNS THE PATH OF THE URL WITHOUT ANY QUERY PARAMS
};
